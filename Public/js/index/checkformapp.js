$(document).ready(function(){
	...
	var cpath = $("#cpath").val();
	  kkpager.generPageHtml({
	       ...
	       //链接前部
	       hrefFormer : cpath+'/index.php/allformapp',
	       //链接尾部
	       hrefLatter : '',
	       getLink : function(n){
...
function checkAccept(id,status)
{
	...
	$.getJSON(cpath+"/index.php/changeformapp",{status:status,id:id},function(data){

		var errorcode = data.errorcode;
		art.dialog.tips(data.msg, 2);
		if(errorcode==-1)
		{
			window.location=cpath+"/index.php/allformapp";
		}else{
			dialog.close();
		}
