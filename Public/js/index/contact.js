$(document).ready(function(){
	...
	var cpath = $("#cpath").val();
	  kkpager.generPageHtml({
	       ...
	       //链接前部
	       hrefFormer : cpath+'/index.php/contact',
	       //链接尾部
	       hrefLatter : '',
	       getLink : function(n){
...
function deleteall()
{
	...
	$.getJSON(cpath+"/index.php/deletecontact",{ids:ids},function(data){

		var errorcode = data.errorcode;
		art.dialog.tips(data.msg, 2);
		if(errorcode==-1)
		{
			window.location=cpath+"/index.php/contact";
		}else{
			dialog.close();
		}
...
function addUser(){
	...
	$.post(cpath+"/index.php/gonewcontact",{},function(data){
		dialog.title("添加联系人");
		dialog.content(data);
	});
}
...
function editcontact(id)
{
	var cpath = $("#cpath").val();
	var dialog = art.dialog({id: 'N3690',title:"正在加载",esc:true,lock:true,drag:false,resize:false,fixed:true});
	$.post(cpath+"/index.php/gonewcontact",{id:id},function(data){
		dialog.title("修改联系人");
		dialog.content(data);
	});
}